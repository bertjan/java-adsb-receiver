package nl.revolution.adsb.decoder;

import nl.revolution.adsb.domain.FlightData;
...
public class Dump1090Source {
    ...
    public Dump1090Source(String dump1090URL, FlightDataService flightDataService) {
            ...
            while (!stop) {
                ...
                for (FlightData currentFlightData : flightDataList) {
                    ...
                    if (!currentFlightData.equals(previousFlightData)) {
                        flightDataService.flightDataReceived(currentFlightData.toMap());
                    }
